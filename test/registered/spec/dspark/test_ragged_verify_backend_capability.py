"""Backend capability and Engram execution checks for ragged-verify graphs.
...
def _capture_verify_graph(hasher, ids, batch):
    def forward():
...
class TestEngramRaggedVerify(CustomTestCase):
    ...
    def test_cuda_graph_replay_updates_request_boundaries(self):
        ...
        graph, output = _capture_verify_graph(hasher, ids, batch)
